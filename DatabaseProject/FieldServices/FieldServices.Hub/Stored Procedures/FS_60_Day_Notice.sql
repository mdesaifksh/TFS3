...
/****** Object:  StoredProcedure [dbo].[FS_60_Day_Notice]    Script Date: 11/12/2018 11:43:28 AM ******/
SET ANSI_NULLS ON
GO
...
Note: Below script is extracted from Mike's Query (11/9/2018)
Change Log:
1.	11/09/2018	VE	Initial Creation


*******************************************************************************************/
CREATE PROCEDURE [dbo].[FS_60_Day_Notice]
AS
BEGIN
